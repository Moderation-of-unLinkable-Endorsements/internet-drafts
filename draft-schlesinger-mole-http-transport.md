...
Moderator policy and accepted Anchor set used for this Site. Different sites MAY
use different policy contexts while sharing the same Moderator. The value MUST
be non-empty.
