...
1. [Architecture](https://moderation-of-unlinkable-endorsements.github.io/internet-drafts/draft-jms-mole-architecture.html) ([Datatracker](https://datatracker.ietf.org/doc/draft-jms-mole-architecture/))
...
4. [Cryptography definitions](https://moderation-of-unlinkable-endorsements.github.io/internet-drafts/draft-authors-mole-crypto.html) (Datatracker - not published yet) - the IHAT Endorsement scheme and the ACT Credential scheme
